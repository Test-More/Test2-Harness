package App::Yath::Schema::DBIC::Result::RunField;
use utf8;
use strict;
use warnings;
...
__PACKAGE__->add_columns(
    ...
    "run_field_id" => {
        ...
        is_auto_increment => 1,
        is_nullable       => 0,
        (is_postgresql() ? (sequence => "run_fields_run_field_id_seq") : ()),
    },
    "run_id" => {
        data_type      => is_sqlite() ? "integer" : "bigint",
        is_foreign_key => 1,
...
App::Yath::Schema::DBIC::Result::RunField - DBIC Result class for the RunField table.
