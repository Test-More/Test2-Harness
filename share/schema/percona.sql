-- Test2::Harness2 Percona schema. Mirrors share/schema/sqlite.sql.
-- Percona Server is a drop-in MySQL replacement; this schema is byte-identical
-- to share/schema/mysql.sql apart from this header.
