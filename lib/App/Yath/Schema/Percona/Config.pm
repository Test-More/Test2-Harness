use utf8;
package App::Yath::Schema::Percona::Config;
...
__PACKAGE__->inflate_column('config_id' => { inflate => \&uuid_inflate, deflate => \&uuid_deflate });
# DO NOT MODIFY ANY PART OF THIS FILE
...
App::Yath::Schema::Percona::Config - Autogenerated result class for Config in Percona.
