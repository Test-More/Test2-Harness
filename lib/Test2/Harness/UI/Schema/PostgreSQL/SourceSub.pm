use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::SourceSub;
package
...
Test2::Harness::UI::Schema::PostgreSQL::SourceSub - Autogenerated result class for SourceSub in PostgreSQL.
