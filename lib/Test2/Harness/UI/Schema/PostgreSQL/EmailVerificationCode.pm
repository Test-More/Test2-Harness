use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::EmailVerificationCode;
package
...
Test2::Harness::UI::Schema::PostgreSQL::EmailVerificationCode - Autogenerated result class for EmailVerificationCode in PostgreSQL.
