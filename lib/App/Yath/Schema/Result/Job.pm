package App::Yath::Schema::Result::Job;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/Job.pm";
require "App/Yath/Schema/Overlay/Job.pm";
...
App::Yath::Schema::Result::Job - Autogenerated result class for Job.
