use utf8;
package Test2::Harness::UI::Schema::MySQL::CoverageManager;
package
...
Test2::Harness::UI::Schema::MySQL::CoverageManager - Autogenerated result class for CoverageManager in MySQL.
