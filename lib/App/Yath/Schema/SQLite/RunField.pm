use utf8;
package App::Yath::Schema::SQLite::RunField;
...
__PACKAGE__->add_unique_constraint("run_field_id_unique", ["run_field_id"]);
...
App::Yath::Schema::SQLite::RunField - Autogenerated result class for RunField in SQLite.
