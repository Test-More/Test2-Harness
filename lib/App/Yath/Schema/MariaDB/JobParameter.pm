use utf8;
package App::Yath::Schema::MariaDB::JobParameter;
...
__PACKAGE__->add_unique_constraint("job_key", ["job_key"]);
...
App::Yath::Schema::MariaDB::JobParameter - Autogenerated result class for JobParameter in MariaDB.
