use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::PrimaryEmail;
package
...
Test2::Harness::UI::Schema::PostgreSQL::PrimaryEmail - Autogenerated result class for PrimaryEmail in PostgreSQL.
