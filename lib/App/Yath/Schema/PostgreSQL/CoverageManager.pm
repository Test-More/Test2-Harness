use utf8;
package App::Yath::Schema::PostgreSQL::CoverageManager;
...
__PACKAGE__->add_columns(
  "coverage_manager_id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "coverage_manager_coverage_manager_id_seq",
  },
  "package",
...
App::Yath::Schema::PostgreSQL::CoverageManager - Autogenerated result class for CoverageManager in PostgreSQL.
