use utf8;
package App::Yath::Schema::SQLite::Sync;
...
__PACKAGE__->add_unique_constraint("source_unique", ["source"]);
...
App::Yath::Schema::SQLite::Sync - Autogenerated result class for Sync in SQLite.
