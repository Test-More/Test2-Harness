package App::Yath2::Options::Tests;
use strict;
use warnings;
...
# TODO: Stage 6 — restore Test2::Harness2::TestSettings import when the
# TestSettings module is ported. Used to seed $DEFAULT_COVER_ARGS for the
# (currently commented-out) `cover` option.
...
option_group {group => 'tests', category => 'Test Options', maybe => 1} => sub {
    # TODO: Stage 6 — activate when a command needs --env-var
    # option env_vars => (
    #     type        => 'Map',
    #     alt         => ['env-var'],
    #     short       => 'E',
    ...
    # TODO: Stage 6 — activate when a command needs --fork
    # option use_fork => (
    #     type          => 'Bool',
    #     alt           => ['fork'],
    ...
    # TODO: Stage 6 — activate when a command needs --load
    # option load => (
    #     type  => 'List',
    #     short => 'm',
    #     alt   => ['load-module'],
    ...
    # TODO: Stage 6 — activate when a command needs --load-import
    # option load_import => (
    #     type  => 'Map',
    #     short => 'M',
    #     alt   => ['loadim'],
    ...
    # TODO: Stage 6 — activate when a command needs --timeout
    # option use_timeout => (
    #     type        => 'Bool',
    #     alt         => ['timeout'],
    ...
    # TODO: Stage 6 — activate when a command needs --tlib
    # option tlib => (
    #     type        => 'Bool',
    ...
    # TODO: Stage 6 — activate --cover when Test2::Harness2::TestSettings is ported
    # option cover => (
    #     type     => 'Auto',
    ...
    # TODO: Stage 6 — activate when a command needs --switches
    # option switches => (
    #     type        => 'List',
    #     alt         => ['switch'],
    #     short       => 'S',
    ...
    # TODO: Stage 6 — activate when a command needs --event-timeout
    ...
    # TODO: Stage 6 — activate when a command needs --post-exit-timeout
    ...
    # TODO: Stage 6 — activate when a command needs --unsafe-inc
    # option unsafe_inc => (
    #     type          => 'Bool',
    ...
    # TODO: Stage 6 — activate when a command needs --stream/--TAP
    # option stream => (
    #     type   => 'Bool',
    #     alt    => ['use-stream'],
    #     alt_no => ['TAP'],
    ...
    # TODO: Stage 6 — activate when a command needs --test-arg
    # option test_args => (
    #     type  => 'List',
    #     alt   => ['test-arg'],
    #     field => 'args',
    ...
    # TODO: Stage 6 — activate when a command needs --input
    # option input => (
    #     type        => 'Scalar',
    #     description => 'Input string to be used as standard input for ALL tests. See also: --input-file',
    # );

    # TODO: Stage 6 — activate when a command needs --input-file
    # option input_file => (
    #     type => 'Scalar',
    #
    ...
    # TODO: Stage 6 — activate when a command needs --event-uuids
    # option event_uuids => (
    #     type => 'Bool',
    #
    ...
    # TODO: Stage 6 — activate when a command needs --mem-usage
    # option mem_usage => (
    #     type => 'Bool',
    #
    ...
    # TODO: Stage 6 — activate when a command needs --allow-retry
    # option allow_retry => (
    #     type        => 'Bool',
    #     description => "Toggle retry capabilities on and off (default: on)",
    # );

    # TODO: Stage 6 — activate when a command needs --retry
    # option retry => (
    #     type  => 'Scalar',
    #     short => 'r',
    #
    ...
    # TODO: Stage 6 — activate when a command needs --retry-isolated
...
App::Yath2::Options::Tests - Options common to all commands that run tests.
