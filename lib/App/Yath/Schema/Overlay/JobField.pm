package App::Yath::Schema::Overlay::JobField;
...
App::Yath::Schema::Result::JobField - Overlay for JobField result class.

=head1 DESCRIPTION

This is where custom (not autogenerated) code for the JobField result class lives.
