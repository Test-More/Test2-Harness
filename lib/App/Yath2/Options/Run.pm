...
option_group {group => 'run', category => "Run Options"} => sub {
    # TODO: Stage 14 — activate --link when run-metadata UI lands
    # option links => (
    #     alt  => ['link'],
    #     type => 'List',
    #
    ...
    # TODO: Stage 14 — activate --dbi-profiling when DB scope returns
    ...
    # TODO: Stage 6 — activate --author-testing when finder author-test mode returns
    ...
    # TODO: Stage 14 — activate --field when run-metadata UI lands
    # option fields => (
    #     alt  => ['field'],
    #     type  => 'List',
    #     short => 'f',
    ...
    # TODO: Stage 14 — activate --run-id when run identity is wired
    # option run_id => (
    #     type    => 'Scalar',
    #     alt     => ['id'],
    #     initialize => \&gen_uuid,
    ...
    # TODO: Stage 14 — activate --abort-on-bail when run abort handling is wired
    ...
    # TODO: Stage 14 — activate --nytprof when profiling support returns
    # option nytprof => (
    #     type => 'Bool',
    ...
    # TODO: Stage 14 — activate --run-auditor when run auditor is wired
    # option run_auditor => (
    #     type => 'Scalar',
    ...
    # TODO: Stage 14 — activate --interactive when interactive run mode returns
    # option interactive => (
    #     type  => 'Bool',
    #     short => 'i',
    #
