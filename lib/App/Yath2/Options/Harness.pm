package App::Yath2::Options::Harness;
use strict;
use warnings;
...
option_group {group => 'harness', category => 'Harness Options'} => sub {
    # TODO: Stage 6 — activate --dummy when harness dummy-mode is wired
    # option dummy => (
    #     type           => 'Bool',
    #     short          => 'd',
    ...
    # TODO: Stage 6 — activate --procname-prefix when harness proc naming is wired
...
App::Yath2::Options::Harness - Options for any command that interacts with the harness API
