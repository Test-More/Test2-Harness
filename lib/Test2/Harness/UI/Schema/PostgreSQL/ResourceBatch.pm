use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::ResourceBatch;
package
...
Test2::Harness::UI::Schema::PostgreSQL::ResourceBatch - Autogenerated result class for ResourceBatch in PostgreSQL.
