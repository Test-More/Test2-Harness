...
option_group {group => 'runner', category => "Runner Options"} => sub {
    # TODO: Stage 8 — activate --preload-early when staged-preload lands
    ...
    # TODO: Stage 8 — activate --preload-retry-delay when staged-preload lands
    ...
    # TODO: Stage 8 — activate --runner class selection when alt runner classes ship
    # option class => (
    #     name    => 'runner',
    #     field   => 'class',
    #     type    => 'Scalar',
    ...
    # TODO: Stage 8 — activate --dump-depmap when staged-preload lands
    # option dump_depmap => (
    #     type        => 'Bool',
    #     default     => 0,
    ...
    # TODO: Stage 8 — activate --reload-in-place when reloader scope returns
    ...
    # TODO: Stage 8 — activate --reloader when reloader scope returns
    # option reloader => (
    #     type => 'Auto',
    #
    ...
    # TODO: Stage 8 — activate --restrict-reload when reloader scope returns
