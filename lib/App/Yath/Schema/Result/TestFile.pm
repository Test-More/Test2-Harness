package App::Yath::Schema::Result::TestFile;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/TestFile.pm";
require "App/Yath/Schema/Overlay/TestFile.pm";
...
App::Yath::Schema::Result::TestFile - Autogenerated result class for TestFile.
