use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::Permission;
package
...
Test2::Harness::UI::Schema::PostgreSQL::Permission - Autogenerated result class for Permission in PostgreSQL.
