use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::Reporting;
package
...
Test2::Harness::UI::Schema::PostgreSQL::Reporting - Autogenerated result class for Reporting in PostgreSQL.
