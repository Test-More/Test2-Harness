package App::Yath::Schema::Result::SessionHost;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/SessionHost.pm";
require "App/Yath/Schema/Overlay/SessionHost.pm";
...
App::Yath::Schema::Result::SessionHost - Autogenerated result class for SessionHost.
