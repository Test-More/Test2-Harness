...
my $f = App::Yath2::Renderer::TerminalAuto::pick(out_fh => $tfh);
...
my $f2 = App::Yath2::Renderer::TerminalAuto::pick(out_fh => $mfh);
...
SKIP: {
    ...
    my $f3 = App::Yath2::Renderer::TerminalAuto::pick();
...
{
    pipe(my $rh, my $wh);
    my $f4 = App::Yath2::Renderer::TerminalAuto::pick(out_fh => $wh);
