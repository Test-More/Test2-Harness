use utf8;
package App::Yath::Schema::SQLite::User;
...
__PACKAGE__->add_columns(
  ...
  "role",
  { data_type => "text", default_value => "user", is_nullable => 0 },
);
...
App::Yath::Schema::SQLite::User - Autogenerated result class for User in SQLite.
