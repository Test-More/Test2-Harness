package App::Yath::Schema::Overlay::Orphan;
...
App::Yath::Schema::Result::Orphan - Overlay for Orphan result class.

=head1 DESCRIPTION

This is where custom (not autogenerated) code for the Orphan result class lives.
