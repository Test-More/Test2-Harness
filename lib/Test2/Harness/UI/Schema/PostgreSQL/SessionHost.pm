use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::SessionHost;
package
...
Test2::Harness::UI::Schema::PostgreSQL::SessionHost - Autogenerated result class for SessionHost in PostgreSQL.
