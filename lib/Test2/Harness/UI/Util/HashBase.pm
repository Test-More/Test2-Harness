...
{
    no warnings 'once';
    $Test2::Harness::UI::Util::HashBase::HB_VERSION = '0.009';
    *Test2::Harness::UI::Util::HashBase::ATTR_SUBS = \%Object::HashBase::ATTR_SUBS;
    *Test2::Harness::UI::Util::HashBase::ATTR_LIST = \%Object::HashBase::ATTR_LIST;
    *Test2::Harness::UI::Util::HashBase::VERSION   = \%Object::HashBase::VERSION;
    *Test2::Harness::UI::Util::HashBase::CAN_CACHE = \%Object::HashBase::CAN_CACHE;
}
...
sub import {
    ...
    my $ver = $Test2::Harness::UI::Util::HashBase::HB_VERSION || $Test2::Harness::UI::Util::HashBase::VERSION;
    $Test2::Harness::UI::Util::HashBase::VERSION{$into} = $ver if !$Test2::Harness::UI::Util::HashBase::VERSION{$into} || $Test2::Harness::UI::Util::HashBase::VERSION{$into} > $ver;

    my $isa = _isa($into);
    my $attr_list = $Test2::Harness::UI::Util::HashBase::ATTR_LIST{$into} ||= [];
    my $attr_subs = $Test2::Harness::UI::Util::HashBase::ATTR_SUBS{$into} ||= {};

    my %subs = (
        ($into->can('new') ? () : (new => \&_new)),
        (map %{$Test2::Harness::UI::Util::HashBase::ATTR_SUBS{$_} || {}}, @{$isa}[1 .. $#$isa]),
        (
            map {
                my $p = substr($_, 0, 1);
                my $x = $_;
...
sub attr_list {
    ...
    my @list = grep { !$seen{$_}++ } map {
        ...
        if (0.004 > ($Test2::Harness::UI::Util::HashBase::VERSION{$_} || 0)) {
            Carp::carp("$_ uses an inlined version of Test2::Harness::UI::Util::HashBase too old to support attr_list()");
        }
        else {
            my $list = $Test2::Harness::UI::Util::HashBase::ATTR_LIST{$_};
            @out = $list ? @$list : ()
        }
...
sub _new {
    ...
    $Test2::Harness::UI::Util::HashBase::CAN_CACHE{$class} = $self->can('init')
        unless exists $Test2::Harness::UI::Util::HashBase::CAN_CACHE{$class};

    $self->init if $Test2::Harness::UI::Util::HashBase::CAN_CACHE{$class};
...
Test2::Harness::UI::Util::HashBase - Build hash based classes.
...
A class:
    ...
    use Test2::Harness::UI::Util::HashBase qw/foo -bar ^baz <bat >ban +boo/;
...
Subclass it
    ...
    use base 'My::Class';
    use Test2::Harness::UI::Util::HashBase qw/bub/;
...
declare it before loading L<Test2::Harness::UI::Util::HashBase>.
    ...
    use Test2::Harness::UI::Util::HashBase qw/foo bar baz/;
...
B<Note:> Test2::Harness::UI::Util::HashBase checks for an init using C<< $class->can('init') >>
...
To generate accessors you list them when using the module:
    ...
    use Test2::Harness::UI::Util::HashBase qw/foo/;
...
Test2::Harness::UI::Util::HashBase provides a function for retrieving a list of attributes for an
Test2::Harness::UI::Util::HashBase class.

=over 4

=item @list = Test2::Harness::UI::Util::HashBase::attr_list($class)

=item @list = $class->Test2::Harness::UI::Util::HashBase::attr_list()
