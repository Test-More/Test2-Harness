use utf8;
package App::Yath::Schema::PostgreSQL::SourceFile;
...
__PACKAGE__->add_columns(
  "source_file_id",
  {
    ...
    is_auto_increment => 1,
    is_nullable       => 0,
    sequence          => "source_files_source_file_id_seq",
  },
  "filename",
...
App::Yath::Schema::PostgreSQL::SourceFile - Autogenerated result class for SourceFile in PostgreSQL.
