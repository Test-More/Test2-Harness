package App::Yath2::Options::Term;
use strict;
use warnings;
...
option_group {group => 'term', category => "Terminal Options"} => sub {
    # TODO: Stage 12 — activate --color when terminal scope expands
    # option color => (
    #     type          => 'Bool',
    #     short         => 'c',
    ...
    # TODO: Stage 12 — activate --progress when terminal scope expands
    # option progress => (
    #     type => 'Bool',
    ...
    # TODO: Stage 12 — activate --term-width when terminal scope expands
    # option term_width => (
    #     type          => 'Scalar',
    #     field         => 'width',
    #     alt           => ['term-size'],
