...
option_group {group => 'resource', category => "Resource Options"} => sub {
    # TODO: Stage 6 — activate --resource when more resource classes ship
    # option classes => (
    #     type  => 'Map',
    #     short => 'R',
    #     name  => 'resources',
    ...
    # TODO: Stage 6 — activate --slots-per-job when multi-slot scheduling lands
    # option job_slots => (
    #     type  => 'Scalar',
    #     alt   => ['slots-per-job'],
    #     short => 'x',
...
App::Yath2::Options::Resource - FIXME
