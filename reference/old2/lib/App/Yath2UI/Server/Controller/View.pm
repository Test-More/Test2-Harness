package App::Yath2UI::Server::Controller::View;
use strict;
use warnings;
...
use App::Yath2UI::Schema::Util qw/find_job_and_try/;
use App::Yath2UI::Server::Response qw/resp error/;


use parent 'App::Yath2UI::Server::Controller';
use Test2::Harness2::Util::HashBase qw/-title/;
...
App::Yath2UI::Server::Controller::View - Used for veiwing items
