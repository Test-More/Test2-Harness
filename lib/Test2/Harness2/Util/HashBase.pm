package Test2::Harness2::Util::HashBase;
use strict;
use warnings;
...
{
    no warnings 'once';
    $Test2::Harness2::Util::HashBase::HB_VERSION = '0.013';
    *Test2::Harness2::Util::HashBase::ATTR_SUBS = \%Object::HashBase::ATTR_SUBS;
    *Test2::Harness2::Util::HashBase::ATTR_LIST = \%Object::HashBase::ATTR_LIST;
    *Test2::Harness2::Util::HashBase::VERSION   = \%Object::HashBase::VERSION;
    *Test2::Harness2::Util::HashBase::CAN_CACHE = \%Object::HashBase::CAN_CACHE;
}
...
sub do_import {
    ...
    my $ver = $Test2::Harness2::Util::HashBase::HB_VERSION || $Test2::Harness2::Util::HashBase::VERSION;
    $Test2::Harness2::Util::HashBase::VERSION{$into} = $ver if !$Test2::Harness2::Util::HashBase::VERSION{$into} || $Test2::Harness2::Util::HashBase::VERSION{$into} > $ver;

    my $isa = _isa($into);
    my $attr_list = $Test2::Harness2::Util::HashBase::ATTR_LIST{$into} ||= [];
    my $attr_subs = $Test2::Harness2::Util::HashBase::ATTR_SUBS{$into} ||= {};

    my %subs = (
        ($into->can('new') ? () : (new => $class->can('_new'))),
        (map %{$Test2::Harness2::Util::HashBase::ATTR_SUBS{$_} || {}}, @{$isa}[1 .. $#$isa]),
...
sub attr_list {
    ...
    my @list = grep { !$seen{$_}++ } map {
        ...
        if (0.004 > ($Test2::Harness2::Util::HashBase::VERSION{$_} || 0)) {
            Carp::carp("$_ uses an inlined version of Test2::Harness2::Util::HashBase too old to support attr_list()");
        }
        else {
            my $list = $Test2::Harness2::Util::HashBase::ATTR_LIST{$_};
            @out = $list ? @$list : ()
        }
...
sub _new {
    ...
    $Test2::Harness2::Util::HashBase::CAN_CACHE{$class} = $self->can('init')
        unless exists $Test2::Harness2::Util::HashBase::CAN_CACHE{$class};

    $self->init if $Test2::Harness2::Util::HashBase::CAN_CACHE{$class};
...
Test2::Harness2::Util::HashBase - Build hash based classes.
...
Subclass it
    ...
    use base 'My::Class';
    use Test2::Harness2::Util::HashBase qw/bub/;
...
You can request an accessor NOT be xs with the '~' prefix:
    ...
    use Test2::Harness2::Util::HashBase '~foo';
...
declare it before loading L<Test2::Harness2::Util::HashBase>.
...
B<Note:> Test2::Harness2::Util::HashBase checks for an init using C<< $class->can('init') >>
...
Test2::Harness2::Util::HashBase provides a function for retrieving a list of attributes for an
Test2::Harness2::Util::HashBase class.

=over 4

=item @list = Test2::Harness2::Util::HashBase::attr_list($class)

=item @list = $class->Test2::Harness2::Util::HashBase::attr_list()
