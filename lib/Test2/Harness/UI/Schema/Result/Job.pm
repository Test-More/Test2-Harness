...
__PACKAGE__->belongs_to(job_facet => 'Test2::Harness::UI::Schema::Result::Facet', 'job_facet_ui_id', {join_type => 'left'});
__PACKAGE__->belongs_to(end_facet => 'Test2::Harness::UI::Schema::Result::Facet', 'end_facet_ui_id', {join_type => 'left'});
