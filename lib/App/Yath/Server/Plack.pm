...
sub router {
    ...
    $router->connect('/view/page/:page_num'                => {controller => 'App::Yath::Server::Controller::View'});
    $router->connect('/view/project/:project_id'           => {controller => 'App::Yath::Server::Controller::View'});
    $router->connect('/view/project/:project_id/:page_num' => {controller => 'App::Yath::Server::Controller::View'});
    $router->connect('/view/user/:user_id'                 => {controller => 'App::Yath::Server::Controller::View'});
    $router->connect('/view/user/:user_id/:page_num'       => {controller => 'App::Yath::Server::Controller::View'});
    ...
    $router->connect('/stream/page/:page_num'                => {controller => 'App::Yath::Server::Controller::Stream'});
    ...
    $router->connect('/stream/user/:user_id/page/:page_num'       => {controller => 'App::Yath::Server::Controller::Stream'});
    $router->connect('/stream/project/:project_id'           => {controller => 'App::Yath::Server::Controller::Stream'});
    $router->connect('/stream/project/:project_id/page/:page_num' => {controller => 'App::Yath::Server::Controller::Stream'});
