use utf8;
package App::Yath::Schema::Percona::EmailVerificationCode;
...
App::Yath::Schema::Percona::EmailVerificationCode - Autogenerated result class for EmailVerificationCode in Percona.
