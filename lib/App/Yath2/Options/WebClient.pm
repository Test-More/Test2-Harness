package App::Yath2::Options::WebClient;
use strict;
use warnings;
...
option_group {group => 'webclient', category => "Web Client Options"} => sub {
    # TODO: Server deferred — activate --url when Server/UI returns
    # option url => (
    #     type => 'Scalar',
    #     alt => ['uri'],
    ...
    # TODO: Server deferred — activate --api-key when Server/UI returns
    # option api_key => (
    #     type => 'Scalar',
    ...
    # TODO: Server deferred — activate --grace when Server/UI returns
    # option grace => (
    #     type => 'Bool',
    ...
    # TODO: Server deferred — activate --request-retry when Server/UI returns
