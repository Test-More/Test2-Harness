package App::Yath::Schema::Result::Config;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/Config.pm";
require "App/Yath/Schema/Overlay/Config.pm";
...
App::Yath::Schema::Result::Config - Autogenerated result class for Config.
