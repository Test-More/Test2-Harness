package App::Yath::Schema::Overlay::Render;
...
App::Yath::Schema::Result::Render - Overlay for Render result class.

=head1 DESCRIPTION

This is where custom (not autogenerated) code for the Render result class lives.
