package App::Yath::Schema::Result::RunField;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/RunField.pm";
require "App/Yath/Schema/Overlay/RunField.pm";
...
App::Yath::Schema::Result::RunField - Autogenerated result class for RunField.
