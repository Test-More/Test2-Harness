...
sub start {
    ...
    App::Yath2UI::Schema::Util::schema_config_from_settings($self->{+SETTINGS});
    ...
    $self->{+PID} = start_process(
        [
            ...
            "-mApp::Yath2UI::Schema::RunProcessor",                    # Load processor
            "-mGetopt::Yath::Settings",                                # Load settings lib
            '-e' => <<"            EOT",                               # Run it.
exit(
    App::Yath2UI::Schema::RunProcessor->process_csnb(
