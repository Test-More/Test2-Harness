use utf8;
package App::Yath::Schema::Percona::JobOutput;
...
__PACKAGE__->add_unique_constraint("job_key", ["job_key", "stream"]);
...
App::Yath::Schema::Percona::JobOutput - Autogenerated result class for JobOutput in Percona.
