use utf8;
package Test2::Harness::UI::Schema::MySQL::EmailVerificationCode;
package
...
Test2::Harness::UI::Schema::MySQL::EmailVerificationCode - Autogenerated result class for EmailVerificationCode in MySQL.
