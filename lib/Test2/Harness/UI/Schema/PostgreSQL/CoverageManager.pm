use utf8;
package Test2::Harness::UI::Schema::PostgreSQL::CoverageManager;
package
...
Test2::Harness::UI::Schema::PostgreSQL::CoverageManager - Autogenerated result class for CoverageManager in PostgreSQL.
