...
option_group {group => 'ipc', category => 'IPC Options'} => sub {
    # TODO: Stage 6 — activate --ipc-dir-order when IPC discovery is wired
    # option dir_order => (
    #     name => 'ipc-dir-order',
    #     type => 'List',
    ...
    # TODO: Stage 6 — activate --ipc-dir when IPC discovery is wired
    # option dir => (
    #     name => 'ipc-dir',
    #     type => 'Scalar',
    ...
    # TODO: Stage 6 — activate --ipc-prefix when IPC discovery is wired
    # option prefix => (
    #     name => 'ipc-prefix',
    #     type => 'Scalar',
    ...
    # TODO: Stage 6 — activate --ipc-protocol when IPC protocol selection is wired
    # option protocol => (
    #     name    => 'ipc-protocol',
    #     type    => 'Scalar',
    #
    ...
    # TODO: Stage 6 — activate --ipc-address when IPC discovery is wired
    # option address => (
    #     name => 'ipc-address',
    #     type => 'Scalar',
    ...
    # TODO: Stage 6 — activate --ipc-file when IPC discovery is wired
    # option file => (
    #     name => 'ipc-file',
    #     type => 'Scalar',
    ...
    # TODO: Stage 6 — activate --ipc-port when IPC discovery is wired
    # option port => (
    #     name => 'ipc-port',
    #     type => 'Scalar',
    ...
    # TODO: Stage 6 — activate --ipc-peer-pid when IPC discovery is wired
    # option peer_pid => (
    #     name => 'ipc-peer-pid',
    #     type => 'Scalar',
    ...
    # TODO: Stage 6 — activate --ipc-allow-multiple when persistent runners ship
