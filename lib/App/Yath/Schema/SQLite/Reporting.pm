use utf8;
package App::Yath::Schema::SQLite::Reporting;
...
__PACKAGE__->add_columns(
  ...
  { data_type => "integer", is_foreign_key => 1, is_nullable => 0 },
  "job_try",
  { data_type => "smallinteger", default_value => \"null", is_nullable => 1 },
  "retry",
...
App::Yath::Schema::SQLite::Reporting - Autogenerated result class for Reporting in SQLite.
