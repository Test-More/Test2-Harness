...
# TODO: Stage 6 — restore find_libraries and chmod_tmp imports when those
# Util helpers are ported to Test2::Harness2::Util.
...
option_group {group => 'workspace', category => 'Workspace Options'} => sub {
    # TODO: Stage 6 — activate --keep-dirs when workspace lifecycle returns
    # option keep_dirs => (
    #     type        => 'Bool',
    #     short       => 'k',
    #     alt         => ['keep-dir'],
    ...
    # TODO: Stage 6 — activate --workdir when workspace lifecycle returns
    # option workdir => (
    #     type           => 'Scalar',
    ...
    # TODO: Stage 6 — activate --tmp-dir when workspace lifecycle returns
    # option tmpdir => (
    #     type           => 'Scalar',
    #     alt            => ['tmp-dir'],
    ...
    # TODO: Stage 6 — activate --clear when workspace lifecycle returns
    # option clear => (
    #     type    => 'Bool',
    #     short       => 'C',
