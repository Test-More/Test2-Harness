package App::Yath::Schema::Overlay::Facet;
...
App::Yath::Schema::Result::Facet - Overlay for Facet result class.

=head1 DESCRIPTION

This is where custom (not autogenerated) code for the Facet result class lives.
