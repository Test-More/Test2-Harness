use utf8;
package App::Yath::Schema::Percona::JobField;
...
__PACKAGE__->add_unique_constraint("job_field_id", ["job_field_id"]);
...
App::Yath::Schema::Percona::JobField - Autogenerated result class for JobField in Percona.
