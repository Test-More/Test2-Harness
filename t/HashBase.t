...
BEGIN {
    package
        main::HBaseSub;
    use base 'main::HBase';
    use Test2::Harness::UI::Util::HashBase qw/apple pear/;
...
BEGIN {
    ...
    package
        main::HBase::Wrapped;
    use Test2::Harness::UI::Util::HashBase qw/foo bar dup/;
...
BEGIN {
    ...
    use Test2::Harness::UI::Util::HashBase qw/baz dup/;
}
...
is_deeply(
    [Test2::Harness::UI::Util::HashBase::attr_list('main::HBase::Wrapped::Inherit')],
    [qw/foo bar dup baz/],
