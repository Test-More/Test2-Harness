package App::Yath::Schema::Overlay::JobParameter;
...
App::Yath::Schema::Result::JobParameter - Overlay for JobParameter result class.

=head1 DESCRIPTION

This is where custom (not autogenerated) code for the JobParameter result class lives.
