package App::Yath::Schema::Overlay::RunParameter;
...
App::Yath::Schema::Result::RunParameter - Overlay for RunParameter result class.

=head1 DESCRIPTION

This is where custom (not autogenerated) code for the RunParameter result class lives.
