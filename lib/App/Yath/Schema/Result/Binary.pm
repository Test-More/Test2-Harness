package App::Yath::Schema::Result::Binary;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/Binary.pm";
require "App/Yath/Schema/Overlay/Binary.pm";
...
App::Yath::Schema::Result::Binary - Autogenerated result class for Binary.
