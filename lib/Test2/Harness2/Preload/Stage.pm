...
Test2::Harness2::Preload::Stage - Abstraction of a preload stage.

=head1 DESCRIPTION

Implementation detail of L<Test2::Harness2::Preload>. You are not intended to
directly use or modify instances of this class. See L<Test2::Harness2::Preload>
for documentation on writing a custom preload library.
