package App::Yath::Schema::Result::Event;
use utf8;
use strict;
use warnings;
...
require "App/Yath/Schema/${App::Yath::Schema::LOADED}/Event.pm";
require "App/Yath/Schema/Overlay/Event.pm";
...
App::Yath::Schema::Result::Event - Autogenerated result class for Event.
